...
#### Para ello crearmos un archivo Python con el siguiente script
Para ello debemos tener instalada la biblioteca (pip install keyboard).
Tras ello, al ejecutarlo nos creara un archivo llamado keystroke.TXT con la información recopilada.
